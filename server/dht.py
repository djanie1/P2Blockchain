...
class Dht(object):
    ...
    #     """ y = asyncio.run(Tracker.run(self))
    #     for p in y:
    ...
    #     #Must be removed
    #     new_peer = self.try_peer_connect()

    #     return self.connected_peers, new_peer
    ...
    #     #me_peer = peer.Peer(self.torrent.file_names, self.torrent.file_sizes, '127.0.0.1', 5432)
    #     #c, p = me_peer.connect()
    #     #print(p)
    #     self.socket.listen()
    ...
    """ async def run(self):
        ...
        key = 'my_key'
        value = 'my_value'
        bootstrap_nodes = Tracker.load_bootstrap_nodes(self)
